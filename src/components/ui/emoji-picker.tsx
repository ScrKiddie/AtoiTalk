  ...
  return (
    ...
    >
      ...
      <EmojiPickerPrimitive.Search
        className="outline-hidden placeholder:text-muted-foreground flex h-10 w-[200px] rounded-md bg-transparent py-3 text-sm disabled:cursor-not-allowed disabled:opacity-50"
    ...
    >
      <EmojiPickerPrimitive.ActiveEmoji>
        {({ emoji }) =>
          emoji ? (
            <>
              <div className="flex h-7 min-w-7 flex-none items-center justify-center text-lg">
                {emoji.emoji}
              </div>
